...
// Source: ./usecase/gateway/jwt/jwt_token.go
...
func (m *MockJwtToken) ValidateToken(token string) bool {
	m.ctrl.T.Helper()
...
func (mr *MockJwtTokenMockRecorder) ValidateToken(token interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateToken", reflect.TypeOf((*MockJwtToken)(nil).ValidateToken), token)
}
